...
def process_video_hd_epic(video, processor, s=None, e=None, aspect_ratio="pad", num_frames=NUM_FRAMES):
    video = [Image.fromarray(f) for f in video]
